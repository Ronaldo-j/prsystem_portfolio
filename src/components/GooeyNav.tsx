  ...
  return (
    <>
      ...
      <div className="relative" ref={containerRef}>
        <button
          className="md:hidden absolute top-2 right-4 z-20 flex flex-col gap-1.5 p-2 bg-black/40 rounded"
        ...
        >
          <ul
            ref={navRef}
            className={`flex gap-8 list-none p-0 px-4 m-0 relative z-[3] transition-all duration-300
              md:flex md:static md:bg-transparent md:shadow-none
              ${
                menuOpen
                  ? "flex-col absolute top-12 left-0 w-full bg-black/90 shadow-2xl rounded-b-xl py-6"
                  : "hidden"
              }
              md:flex`}
            style={{
